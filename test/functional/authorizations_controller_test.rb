...
class AuthorizationsControllerTest < ActionController::TestCase
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post :create, authorization: { fresh_token: @authorization.fresh_token, provider: @authorization.provider, secret: @authorization.secret, settings: @authorization.settings, token: @authorization.token, uid: @authorization.uid, user_id: @authorization.user_id }
    end
  ...
  test "should update authorization" do
    put :update, id: @authorization, authorization: { fresh_token: @authorization.fresh_token, provider: @authorization.provider, secret: @authorization.secret, settings: @authorization.settings, token: @authorization.token, uid: @authorization.uid, user_id: @authorization.user_id }
    assert_redirected_to authorization_path(assigns(:authorization))
  end
